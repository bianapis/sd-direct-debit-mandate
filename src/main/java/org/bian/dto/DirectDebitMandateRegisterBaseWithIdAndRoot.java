...
/**
 * DirectDebitMandateRegisterBaseWithIdAndRoot
 */
public class DirectDebitMandateRegisterBaseWithIdAndRoot   {
  private String directDebitMandateRegistrationReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: reference to the registration of a new direct debit mandate 
   * @return directDebitMandateRegistrationReference
  **/

  public String getDirectDebitMandateRegistrationReference() {
    return directDebitMandateRegistrationReference;
  }

  public void setDirectDebitMandateRegistrationReference(String directDebitMandateRegistrationReference) {
    this.directDebitMandateRegistrationReference = directDebitMandateRegistrationReference;
  }
