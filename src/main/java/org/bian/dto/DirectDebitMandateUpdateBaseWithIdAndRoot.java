...
/**
 * DirectDebitMandateUpdateBaseWithIdAndRoot
 */
public class DirectDebitMandateUpdateBaseWithIdAndRoot   {
  private String directDebitMandateUpdateReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: reference to updates made to an existing direct debit mandate 
   * @return directDebitMandateUpdateReference
  **/

  public String getDirectDebitMandateUpdateReference() {
    return directDebitMandateUpdateReference;
  }

  public void setDirectDebitMandateUpdateReference(String directDebitMandateUpdateReference) {
    this.directDebitMandateUpdateReference = directDebitMandateUpdateReference;
  }
